...
export default function ProjectsLayout({
  ...
  const tabs = [
    { value: 'overview', label: 'Overview', path: '/projects/overview' },
    { value: 'board', label: 'Task Board', path: '/projects/board' },
    { value: 'team', label: 'Team', path: '/projects/team' },
    { value: 'analytics', label: 'Analytics', path: '/projects/analytics' },
    { value: 'resources', label: 'Resources', path: '/projects/resources' },
    { value: 'documents', label: 'Documents', path: '/projects/documents' },
  ]
