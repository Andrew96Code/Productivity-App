...
export default function FinancesLayout({
  ...
  const tabs = [
    { value: 'overview', label: 'Overview', path: '/finances/overview' },
    { value: 'goals', label: 'Goals', path: '/finances/goals' },
    { value: 'budget', label: 'Budget', path: '/finances/budget' },
    { value: 'expenses', label: 'Expenses', path: '/finances/expenses' },
    { value: 'investments', label: 'Investments', path: '/finances/investments' },
    { value: 'education', label: 'Education', path: '/finances/education' },
  ]
        ...
        <div className="container mx-auto p-4">
          <div className="mb-4">
            <div>
              ...
              <p className="text-muted-foreground">Track and manage your financial journey</p>
            </div>
          </div>
